...
${OBJECTDIR}/Skip\ List\ implementation.o: Skip\ List\ implementation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Skip\ List\ implementation.o Skip\ List\ implementation.cpp

.NO_PARALLEL:${OBJECTDIR}/Skip\ list\ assignment.o
${OBJECTDIR}/Skip\ list\ assignment.o: Skip\ list\ assignment.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Skip\ list\ assignment.o Skip\ list\ assignment.cpp

${OBJECTDIR}/b_tree.o: b_tree.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/b_tree.o b_tree.cpp

${OBJECTDIR}/fibonaccci_project.o: fibonaccci_project.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fibonaccci_project.o fibonaccci_project.cpp

${OBJECTDIR}/kd_tree.o: kd_tree.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kd_tree.o kd_tree.cpp

${OBJECTDIR}/kd_tree1.o: kd_tree1.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/kd_tree1.o kd_tree1.cpp

${OBJECTDIR}/point_region_quad_tree.o: point_region_quad_tree.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/point_region_quad_tree.o point_region_quad_tree.cpp

${OBJECTDIR}/position_heap.o: position_heap.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/position_heap.o position_heap.cpp

${OBJECTDIR}/quad_tree.o: quad_tree.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/quad_tree.o quad_tree.cpp

${OBJECTDIR}/red-black.o: red-black.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/red-black.o red-black.cpp

${OBJECTDIR}/skip_list.o: skip_list.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/skip_list.o skip_list.cpp
